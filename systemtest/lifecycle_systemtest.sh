...
#    hetzner, ovh, upcloud, digitalocean, and opt-in scaleway. For each selected
#    provider and each selected Kubernetes distribution (k3s, kubeadm) it
#    provisions a REAL cluster and exercises the full lifecycle, asserting the
