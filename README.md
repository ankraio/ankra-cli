...
| [ankra pipeline](https://docs.ankra.ai/reference/cli/pipeline) | Run, watch and manage Ankra Pipelines: connect, list and get pipeline repositories, dispatch a run, list and inspect runs, follow step logs, cancel or re-run, download artifacts, validate `.ankra/pipeline.yaml`, and manage the definition and its schedules |
