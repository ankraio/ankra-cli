...
#### Applications
```bash
ankra application add .                                  # Add the current GitHub checkout
ankra application add ./services/api --name api          # Use another local checkout
ankra application add . --credential github-acme         # Select a GitHub credential
ankra application add . --branch main --remote upstream  # Override Git detection
ankra application add . -o json                          # Machine-readable result
```
