...
type APIClient interface {
	...
	UpdateOvhNodeGroupLabels(clusterID, groupName string, labels map[string]string) (*client.UpdateNodeGroupResult, error)
	UpdateOvhNodeGroupTaints(clusterID, groupName string, taints []client.NodeTaint) (*client.UpdateNodeGroupResult, error)
