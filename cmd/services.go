...
type APIClient interface {
	...
	GetAwsAccessInfo(clusterID string) (*client.ClusterAccessInfo, error)
	ListAwsRegions(credentialID string) (*client.AwsCatalogResult, error)
	ListAwsInstanceTypes(credentialID, region string) (*client.AwsCatalogResult, error)
	ListAwsVpcs(credentialID, region string) (*client.AwsCatalogResult, error)
	ListAwsSubnets(credentialID, region, vpcID string) (*client.AwsCatalogResult, error)
	ListAwsAvailabilityZones(credentialID, region string) (*client.AwsCatalogResult, error)
	ListAwsImages(credentialID, region string) (*client.AwsCatalogResult, error)
	ListAwsPricing(credentialID, region string) (*client.AwsCatalogResult, error)
	ListAwsClusterInstanceTypes(clusterID string) (*client.AwsCatalogResult, error)
